...
function Body({ chooseTrack, spotifyApi }) {
  ...
  return (
    <section className="bg-black ml-24 py-4 space-y-8 md:max-w-5xl lg:max-w-6xl flex-grow md:mr-2.5">
      <Search search={search} setSearch={setSearch} />
      <div className="grid overflow-y-scroll scrollbar-hide h-96 py-4 grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-x-4 gap-y-8 p-4">
      ...
      <div className="flex gap-x-8 absolute min-w-full md:relative ml-6">
        {/* Genres */}
        <div className="hidden 2xl:inline max-w-[270px]">
